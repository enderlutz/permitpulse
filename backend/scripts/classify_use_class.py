...
RULES: list[tuple[str, re.Pattern]] = [
    ...
    ("warehouse",  re.compile(r"\b(WAREHOUSE|WHSE|NEW WHSE|STORAGE FACIL|STORAGE BLDG|DISTRIBUTION CTR|DISTRIBUTION CENTER|DISTRIBUTION CENTRE|FULFILLMENT|LOGISTICS CTR|LOGISTICS CENTER|LOGISTICS CENTRE|LOGISTICS PARK|MANUFACTURING PLT|INDUSTRIAL BLDG)\b", re.I)),
